...
<h2>Description</h2>
<b>This repository explains how to make groups in Active Directory and, how to apply them to file permissions. Next we go over how to install the file server software in Server Manager and finally how to set up a network share so users can access the files over the network.</b>
